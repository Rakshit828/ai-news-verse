...
class Scraper:
    ...
    def get_entries_from_rss_feed(self, cutoff_hours: int = 24) -> List[Dict]:
...
if __name__ == '__main__':
    ...
    result = scraper.scrape_url(url='https://hackernoon.com/meet-toon-the-format-helping-llms-shed-jsons-extra-weight?source=rss')
