...
from src.db.init_data import INITIAL_CATEGORIES_DATA
from src.models.ai_news_service import (
    GoogleNewsResponse,
...
from src.core.ai.components.pinecone_db import (
    PineconeServiceAsync,
    TopicKeywordRecord,
    PrimaryCategoryRecord,
)
from src.core.ai.components.topic_description_generator import (
...
class CategoriesDBService(BaseDBInteractions):
    ...
    async def create_custom_category(
        ...
        session: AsyncSession,
        pinecone_client: PineconeServiceAsync,
    ) -> ResponseCategoryDataModel:
