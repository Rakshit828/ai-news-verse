...
from src.domains.news.models import CategoriesDataResponse, UpdateUsersCategoryModel, SetUsersCategoryModel
...
class NewsCategoryRepository:
    ...
    async def get_categories_data(self, session: AsyncSession) -> CategoriesDataResponse:
    ...
    async def update_user_categories(
        self,
        user_id: str,
        categories_data: UpdateUsersCategoryModel,
...
async def main():
    ...
    async for session in get_session():
        result = await repo.get_categories_data(session)
